...
class CartBay_Email_Recovery_1 extends AbstractCartBayRecoveryEmail {
	...
	public function __construct() {
		...
		$this->default_body_content = __( '<p>Hi there,</p><p>You were close to checking out, so we saved your cart for you.</p><p>Come back while everything is still fresh and finish your order in just a few clicks.</p>', 'cartbay-abandoned-cart-recovery-for-woocommerce' );
