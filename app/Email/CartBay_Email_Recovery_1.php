...
class CartBay_Email_Recovery_1 extends AbstractCartBayRecoveryEmail {
	...
	public function __construct() {
		...
		$this->title                = __( 'CartBay: Recovery Email 1', 'cartbay' );
		$this->description          = __( 'First abandoned cart recovery email.', 'cartbay' );
		$this->customer_email       = true;
		$this->template_base        = CARTBAY_DIR . 'templates/';
		$this->template_html        = 'emails/recovery-email-1.php';
		$this->template_plain       = '';
		$this->default_subject      = __( '[{site_title}] You left something in your cart', 'cartbay' );
		$this->default_heading      = __( 'You left something behind', 'cartbay' );
		$this->default_preheader    = __( 'Pick up where you left off before your cart goes cold.', 'cartbay' );
		$this->default_cta_label    = __( 'Return to My Cart', 'cartbay' );
