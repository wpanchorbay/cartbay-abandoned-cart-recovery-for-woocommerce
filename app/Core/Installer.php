	...
	private static function seed_default_templates(): void {
		$default_templates = array(
			array(
				...
				'content'    => '<p>Hi there,</p><p>You were close to checking out, so we saved your cart for you.</p><p>Come back while everything is still fresh and finish your order in just a few clicks.</p>',
				'subject'    => '[{site_title}] You left something in your cart',
				'heading'    => 'You left something behind',
				'preheader'  => 'Pick up where you left off before your cart goes cold.',
				'cta_label'  => 'Return to My Cart',
				'preset_key' => 'friendly_reminder',
			),
			array(
				'title'      => 'Recovery Email 2',
				'content'    => '<p>Still thinking it over?</p><p>Your cart is still waiting for you, and checkout only takes a moment.</p><p>If anything was getting in the way, this is a great time to jump back in and complete your order.</p>',
				'subject'    => '[{site_title}] Your cart is waiting for you',
				'heading'    => 'Still thinking about it?',
				'preheader'  => 'Your saved cart is ready whenever you are.',
				'cta_label'  => 'Complete My Order',
				'preset_key' => 'value_follow_up',
			),
			array(
				'title'      => 'Recovery Email 3',
				'content'    => '<p>This is your last chance to complete your order.</p><p>Your cart is still saved and ready for you. If you still want these items, now is the best time to come back.</p>',
				'subject'    => '[{site_title}] Last chance to complete your order',
				'heading'    => 'Your cart is still here',
				'preheader'  => 'A final reminder to finish checking out before your cart expires.',
				'cta_label'  => 'Claim My Cart',
