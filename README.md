...
[![WordPress.org](https://img.shields.io/badge/WordPress.org-Plugin-21759b?style=for-the-badge&logo=wordpress&logoColor=white)](https://wordpress.org/plugins/cartbay-abandoned-cart-recovery-for-woocommerce/)
...
![WooCommerce](https://img.shields.io/badge/WooCommerce-9.8%2B-96588a?style=flat-square&logo=woocommerce&logoColor=white)
...
[**WordPress.org**](https://wordpress.org/plugins/cartbay-abandoned-cart-recovery-for-woocommerce/) · [**Documentation**](https://docs.wpanchorbay.com/cartbay/) · [**Product page**](https://wpanchorbay.com/plugins/cartbay/) · [**Support**](https://wordpress.org/support/plugin/cartbay-abandoned-cart-recovery-for-woocommerce/)
...
1. Install **CartBay** from the [WordPress.org plugin directory](https://wordpress.org/plugins/cartbay-abandoned-cart-recovery-for-woocommerce/) (**Plugins → Add New**), or upload the plugin ZIP.
...
Yes - CartBay requires WooCommerce 9.8 or higher.
...
- **Bug reports & feature requests:** [GitHub issues](https://github.com/wpanchorbay/cartbay-abandoned-cart-recovery-for-woocommerce/issues)
- **Community support:** [WordPress.org support forum](https://wordpress.org/support/plugin/cartbay-abandoned-cart-recovery-for-woocommerce/)
- **Documentation:** [docs.wpanchorbay.com/cartbay](https://docs.wpanchorbay.com/cartbay/)

When reporting a bug, please include a clear description of the problem, steps to reproduce it, and any screenshots or error logs.
...
**Prerequisites:** PHP 8.0+, Composer, and [Bun](https://bun.sh) for JS builds.
...
```bash
bun run build           # compile src/ → assets/ (via @wordpress/scripts)
bun run start           # watch build while developing
...
```bash
composer phpcs          # PHPCS (phpcs.xml) - zero violations
...
```
app/Admin/Settings/  - settings sections (capture, offers, notifications, templates, logs, overview)
app/Admin/Wizard/    - setup wizard
app/Api/Routes/      - REST route classes
app/Core/            - bootstrap, container, installer, checkout fields, privacy
app/Data/            - SessionRepository
app/Email/           - WC_Email subclasses (3 recovery emails)
app/Recovery/        - capture, abandonment scheduling, email sequence, notifications, restore, order matching
app/Analytics/       - analytics service
app/Utils/           - TokenHelper, RateLimiter, Logger
src/                 - checkout capture scripts (classic + block), built with @wordpress/scripts
templates/emails/    - WC email HTML templates
assets/              - compiled JS/CSS (shipped un-minified)
tests/               - PHPUnit tests
```
...
- **Capture:** public REST endpoint `cartbay/v1/capture`, shared by classic and block checkout.
